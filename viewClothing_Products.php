        ...
        <div class="nav__bar">
            <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
                <div class="container-fluid my-3" style="margin-left: 30px;">
                    ...
                    <a class="navbar-brand nav__logo mx-5" href="#">Clothing Products</a>
        ...
        align-self: center; text-align: center;">
            <div style="margin-top: 100px;">
                <span style="color: white;">
                    <h2>Clothing Products for Installment</h2>
                </span>
            </div>
            <div class="row row-cols-1 row-cols-md-2 g-4 my-4">
                ...
                <div class="col">
                    <div class="card modal-body">
                        <div class="img-container">
                            <div class="image">
                                <img src="./assets/img/kurta.jpg" style="width: 150px; height: 150px; 
                                margin-top: 10px; align-self: center" class="card-img-top" data-index="8" alt="...">
                            </div>
                        </div>
