                ...
                <div class="col">
                    <div class="card modal-body">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Luxuries bed you can buy on installments now:
                            <ul>
                                <li><i>Right Size.</li>
                                <li>Perfect Ergonomics.</li>
                                <li>Pure Hygienic.</li>
                        ...
                        <div class="img-container">
                            <div class="image">
                                <img style="width: 150px; height: 150px; align-self: center;  margin-top: 10px;"
                                    src="./assets/img/chair.jpg" class="card-img-top" data-index="5" alt="...">
                            </div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Wooden Chairs</h5>
                            <p class="card-text">Electric heater, device for heating rooms. It lets you give:
                            <ul>
                                <li><i>High Quality Wood.</li>
                                <li>Finesse into a Room.</li>
                                <li>Attractive-Wooden .</li>
                                <li>Resistant to Weather</li>
                                </i>
                            </ul>
                            </p>
                            <h6 class="card-title">Category: Furniture</h6>
