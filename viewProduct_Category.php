        ...
        <div class="nav__bar">
            <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
                <div class="container-fluid my-3" style="margin-left: 30px;">
                    ...
                    <a class="navbar-brand nav__logo mx-5" href="#">Product Categories</a>
        ...
        align-self: center; text-align: center;">
            <div style="margin-top: 100px;">
                <span style="color: white;">
                    <h2>Available Categories for Installment</h2>
                </span>
            </div>
            <div class="row row-cols-1 row-cols-md-2 g-4 my-4">
                <div class="col">
                    <div class="card modal-body" style="height: 30rem;">
                        <div class="img-container">
                            <div class="image my-3">
                                <img style="width: 150px; height: 150px; align-self: center;  margin-top: 10px;"
                                    src="./assets/img/electric.jpg" class="card-img-top" data-index="1" alt="...">
                            </div>
                        </div>
                        <div class="popup-img">
                            <span>&times;</span>
                            <img src="./assets/img/electric.jpg" />
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Electric Products</h5>
                            <p class="card-text">You can get these on installments:
                            <ul>
                                <li><i>Electric Heater.</li>
                                <li>Electric Fridge</li>
                                </i>
                            </ul>
                            </p>
                            <h6 class="card-title">Category: Electric</h6>
                            <a type="button" href="viewElectric_Products.php" class="button button--flex" style="height: 40px; align-self: center">View Products of this category</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card modal-body" style="height: 30rem;">
                        <div class="img-container">
                            <div class="image my-3">
                                <img src="./assets/img/furniture.jpg" style="width: 150px; height: 150px; margin-top: 10px;
                                align-self: center" class="card-img-top" data-index="4" alt="...">
                            </div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Furniture Products</h5>
                            <p class="card-text">You can get these on installments:
                            <ul>
                                <li><i>Luxury Bed.</li>
                                <li>Wooden Chairs.</li>
                            ...
                            <h6 class="card-title">Category: Furniture</h6>
                            <a type="button" href="viewFurniture_Products.php" class="button button--flex" style="height: 40px; align-self: center">View Products of this category</a>
                ...
                <div class="col">
                    <div class="card modal-body" style="height: 30rem;">
                        <div class="img-container">
                            <div class="image my-3">
                                <img src="./assets/img/cosmatic.jpg" style="width: 150px; height: 150px; margin-top: 10px;
                                align-self: center" class="card-img-top" data-index="7" alt="...">
                            </div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Cosmetic Products</h5>
                            <p class="card-text">You can get these on installments:
                            <ul>
                                <li><i>All Makeup Kit.</li>
                                <li>Only Eye Makeup Kit.</li>
                               </i>
                            </ul>
                            </p>
                            <h6 class="card-title">Category: Cosmetics</h6>
                            <a type="button" href="viewCosmatic_Products.php" class="button button--flex" style="height: 40px; align-self: center">View Products of this category</a>
                ...
                <div class="col">
                    <div class="card modal-body" style="height: 30rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Clothing Products</h5>
                            <p class="card-text">You can get these on installments:
                            <ul>
                                <li><i>T-Shirt.</li>
                                <li>Kurta.</li>
                            ...
                            <a type="button" href="viewClothing_Products.php" class="button button--flex" style="height: 40px; align-self: center">View Products of this category</a>
